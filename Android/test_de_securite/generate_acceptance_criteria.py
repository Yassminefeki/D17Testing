#!/usr/bin/env python3
"""Generate acceptance criteria for security tests."""

ACCEPTANCE_CRITERIA = """# Acceptance Criteria — Test de sécurité
...
if __name__ == "__main__":
    ...
    print("✓ Generated acceptance_criteria.md for test_de_securite")
